...
public class ChangeInfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Change Which Type:");

        jComboBox1.setFont(new java.awt.Font("Calibri", 0, 22)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[]{"Type1", "Type2", "Type3", "Type4"}));
    ...
    private void BeforeChange(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BeforeChange
        BeforeChange be = new BeforeChange();
        this.setVisible(false);
        be.setVisible(true);
    }//GEN-LAST:event_BeforeChange
